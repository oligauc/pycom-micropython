...
PY_AJ_OBJECT_t *py_aj_obj_root = NULL;

void freeResources(void);
bool isUniqueMethod(PY_AJ_ITF_t *node, char *method);
uint8_t getNumAjObjects(PY_AJ_OBJECT_t * root);
uint8_t getNumInterfaces(PY_AJ_ITF_t *node);
bool getInterfaceIndices(PY_AJ_ITF_t *node, const char *interface_name, const char *interface_methods, uint8_t *indices);
uint8_t findUniqueMethods(PY_AJ_ITF_t *node, char **new_methods, uint8_t num_new, uint8_t *unique_index);
void addMethods(PY_AJ_ITF_t *node, char **new_methods, uint8_t num_methods, mp_obj_t *new_callbacks);
void addInterfaceName(PY_AJ_OBJECT_t *node, char* new_interface_name, char **new_interface_methods, uint8_t num_methods, mp_obj_t *new_callbacks);
void newInterface(PY_AJ_ITF_t **node, char *new_interface_name, char **new_interface_methods, uint8_t num_methods, mp_obj_t *new_callbacks);
void newServicePath(PY_AJ_OBJECT_t **node, char *new_service_path);
void newObject(PY_AJ_OBJECT_t **node, char* new_service_path, char* new_interface_name, char **new_interface_methods, uint8_t num_methods, mp_obj_t *new_callbacks);
...
bool getInterfaceIndices(PY_AJ_ITF_t *node, const char *interface_name, const char *interface_method, uint8_t *indices){
...
void newInterface(PY_AJ_ITF_t **node_itf, char *new_interface_name, char **new_interface_methods, uint8_t num_methods, mp_obj_t *new_callbacks) {
